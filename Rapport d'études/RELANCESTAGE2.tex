...
\includepdfmerge[nup=1x2, angle=90, linktodoc, scale = 0.80, offset =30mm -30mm]
...
\boitesimple{
	...
	\begin{center}
	\begin{equation} \large{
	_{(s;y)}C_{(i;i+1)}^t = \frac{_{(s;y)}Q_{(i;i+1)}^t}{_{(s)}Q_{(i;i+1)}^t} }
	\end{equation}
	\end{center}
	\\C $\in \mathbb{R}^*$ \\
...
\hline
	...
	&	 \multicolumn{2}{|c|}{Q_{i;i+1} p.100 000}&	\multicolumn{8}{|c|}{Risque relatif selon le sexe, du sous-groupe / Ensemble}\\	\hline
	&	\multicolumn{2}{|c|}{Ensemble}&	\multicolumn{2}{|c|}{Sans diplôme}&	\multicolumn{2}{|c|}{BEP-CAP} &	\multicolumn{2}{|c|}{Bac}&\multicolumn{2}{|c|}{Etudes sup.}\\	\hline
Âge exact	&	 H 	&	 F 	&	 H 	&	 F 	&	 H 	&	 F 	&	 H 	&	 F 	&	 H 	&	 F 	\\	\hline}
\tablehead{%
\hline
\multicolumn{11}{|l|}{\small\sl ... Suite}\\ \hline
	&	\multicolumn{10}{|c|}{ 2013 } \\	\hline
	&	 \multicolumn{2}{|c|}{Q_{i;i+1} p.100 000}&	\multicolumn{8}{|c|}{Risque relatif selon le sexe, du Sous-groupe / Ensemble}\\	\hline
	&	\multicolumn{2}{|c|}{Ensemble}&	\multicolumn{2}{|c|}{Sans diplôme}&	\multicolumn{2}{|c|}{BEP-CAP} &	\multicolumn{2}{|c|}{Bac}&\multicolumn{2}{|c|}{Etudes sup.}\\	\hline
Âge	exact &	 H 	&	 F 	&	 H 	&	 F 	&	 H 	&	 F 	&	 H 	&	 F 	&	 H 	&	 F 	\\	\hline}
...
\hline}
\tablelasttail{\hline}
\begin{supertabular}{|p{1.1cm}||p{1.2cm}|p{1.2cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|}
